...
for i in dictDataFrames.keys():
    ...
    exportFile = 'C:/GitHub/OpenDataCustomerAnalytics/demographicsData/demographicsStructure/{0}_demographicsStructure_CountryRelative.csv'.format(i)
